...
<body class="bg-[#dbeafe] flex h-screen overflow-hidden text-slate-800" x-data="{ sidebarOpen: true, activeMenu: 'dashboard' }">
    ...
    @php
        $pembimbing = ['nama' => 'Riski S.Pd', 'desc' => 'Yang akan membimbing anda selama di Dinas Pariwisata Kabupaten Bantul'];
        $unggahanAktivitas = [['file' => 'File_YangDiUpload.PDF', 'status' => 'Diterima'], ['file' => 'File_YangDiUpload.PDF', 'status' => 'Diterima'], ['file' => 'File_YangDiUpload.PDF', 'status' => 'Diterima'], ['file' => 'File_YangDiUpload.PDF', 'status' => 'Ditinjau']];
        $unggahanLaporan = [['file' => 'Laporan_Mingguan.PDF', 'status' => 'Diterima'], ['file' => 'Laporan_Akhir.PDF', 'status' => 'Diterima'], ['file' => 'Laporan_Kegiatan.PDF', 'status' => 'Diterima'], ['file' => 'Revisi_Laporan.PDF', 'status' => 'Ditinjau']];
        $logActivity = [['date' => 'Wednesday, 10 August 2025', 'status' => 'Diterima'], ['date' => 'Wednesday, 11 August 2025', 'status' => 'Diterima'], ['date' => 'Wednesday, 12 August 2025', 'status' => 'Ditinjau']];
    @endphp
